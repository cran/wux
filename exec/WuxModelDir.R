...
################################################################################
    'NorESM1-M-r1i1p1_rcp85' = list( 
      ...
      file.path.alt = list(
        air_temperature =
        list(reference.period = "/home/thm/tmp/CMIP5/NorESM1-M/historical",
             scenario.period =  "/home/thm/tmp/CMIP5/NorESM1-M/rcp85"),
...
################################################################################
    'CanESM2-r1i1p1_rcp85' = list( 
      ...
      file.path.alt = list(
        air_temperature =
        list(reference.period = "/home/thm/tmp/CMIP5/CanESM2/historical",
             scenario.period =  "/home/thm/tmp/CMIP5/CanESM2/rcp85"),
        precipitation_amount =
        list(reference.period = "/home/thm/tmp/CMIP5/CanESM2/historical",
             scenario.period =  "/home/thm/tmp/CMIP5/CanESM2/rcp85")),
      file.name = list(
